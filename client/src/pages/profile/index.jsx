...
const Profile = () => {
  ...
  const handleNavigate = () => {
    if (userInfo.profileSetup) {
      navigate("/chat");
    } else toast.error("Please complete the profile first !");
  };
  ...
  return (
    <div className="bg-[#1b1c24] h-[100vh] flex flex-col items-center justify-center  gap-10">
      <div className="flex flex-col gap-10 w-[80vm] md:w-max">
        <div onClick={handleNavigate}>
          <IoArrowBack className="text-3xl lg:text-5xl text-white/90 cursor-pointer" />
        </div>
